             ...
             {/* TopLogo */}
               <View style={{width:'100%',alignItems:'center',justifyContent:'center',flexDirection:'row'}}>
                    ...
                    {/* <View style={{width:'60%',justifyContent:'flex-end',alignItems:'flex-end'}}> */}
                      <Image style={{width:80,height:90}} source={require('../assets/adaptive-icon-png.jpg')} />
                 
                </View>
                    <Text style={{color:"#7FAFAF",fontSize:12,textAlign:"center",paddingHorizontal:66,paddingVertical:20,letterSpacing:.5,fontFamily: 'Poppins_400Regular'}}>
